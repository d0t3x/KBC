...
public class KLoader {
    ...
    public static KLoader getLoader(ChatSystem cs, AppletCache cache) {
        if (!loaders.containsKey(cs)) {
            ...
            for (ChatSystem css : loaders.keySet())
                if (css.getCacheVersion().equals(cs.getCacheVersion())) {
    ...
    public void prepare() {
        ...
        ClientFrame.get().setProgressLog("Preparing Classes...");
        this.currentStep++;
        ...
        this.ready = true;
        ClientFrame.get().setProgressLog("Manipulation complete");
    }
    ...
    private void prepareGroupChat() {
        try {
            ...
            ClientFrame.get().setProgressLog("Change Method getParameter");
            this.currentStep++;
            ...
            ClientFrame.get().setProgressLog("Change Method getDocumentBase");
            this.currentStep++;
            ...
            ClientFrame.get().setProgressLog("Add Method getCodeBase");
            this.currentStep++;
            groupChat.addMethod(CtMethod.make(
            ...
            ClientFrame.get().setProgressLog("Add Method getAppletContext");
            this.currentStep++;
            groupChat.addMethod(CtMethod.make(
            ...
            ClientFrame.get().setProgressLog("Rename Method " + this.system.getManipulation().getGroupChatInput() +
                    " (Input) to processInput");
            this.currentStep++;
            ...
            Logger.get().info("     - Add Method " + this.system.getManipulation().getGroupChatInput() +
                    " (Input)");
            ClientFrame.get().setProgressLog("Add Method " + this.system.getManipulation().getGroupChatInput() +
                    " (Input)");
            this.currentStep++;
            groupChat.addMethod(CtMethod.make(
            ...
            ClientFrame.get().setProgressLog("Rename Method " + this.system.getManipulation().getGroupChatOutput() +
                    " (Output) to processOutput");
            this.currentStep++;
            ...
            Logger.get().info("     - Add Method " + this.system.getManipulation().getGroupChatOutput() +
                    " (Output)");
            ClientFrame.get().setProgressLog("Add Method " + this.system.getManipulation().getGroupChatOutput() +
                    " (Output)");
            this.currentStep++;
            groupChat.addMethod(CtMethod.make(
            ...
            ClientFrame.get().setProgressLog("Rename Method " + this.system.getManipulation().getGroupChatMdlInput() +
                    " (ModuleInput) to processModule");
            ...
            Logger.get().info("     - Add Method " + this.system.getManipulation().getGroupChatMdlInput() +
                    " (ModuleInput)");
            ClientFrame.get().setProgressLog("Add Method " + this.system.getManipulation().getGroupChatMdlInput() +
                    " (ModuleInput)");
            this.currentStep++;
            groupChat.addMethod(CtMethod.make(
            ...
            ClientFrame.get().setProgressLog("Add Method receive");
            this.currentStep++;
            groupChat.addMethod(CtMethod.make(
            ...
            ClientFrame.get().setProgressLog("Add Method send");
            this.currentStep++;
            groupChat.addMethod(CtMethod.make(
            ...
            */
            ...
            ClientFrame.get().setProgressLog("Add Method getChannels");
            this.currentStep++;
            groupChat.addMethod(CtMethod.make(
            ...
            ClientFrame.get().setProgressLog("Add Method getModuleParent");
            this.currentStep++;
            groupChat.addMethod(CtMethod.make(
    ...
    private void prepareModule() {
        try {
            ...
            ClientFrame.get().setProgressLog("Prepare Module (" + module.getName() + ")");
            this.currentStep++;

            module.addField(CtField.make("private String tree;", module));
            this.currentStep++;
            Logger.get().info("     - Add Field tree");
            ClientFrame.get().setProgressLog("Add Field tree");

            Logger.get().info("     - Change Method reset (" + this.system.getManipulation().getModuleReset() + ")");
            ClientFrame.get().setProgressLog("Change Method reset (" + this.system.getManipulation().getModuleReset() + ")");
            this.currentStep++;
            ...
            ClientFrame.get().setProgressLog("Add Method getTree");
            this.currentStep++;
    ...
    private void prepareGameHandler() {
        try {
            ...
            ClientFrame.get().setProgressLog("Prepare GameHandler (" + handler.getName() + ")");
            this.currentStep++;

            Logger.get().info("     - Change Field Modifier");
            ClientFrame.get().setProgressLog("Change Field Modifier");
            this.currentStep++;
    ...
    private void prepareSmileyWars() {
        try {
            ...
            ClientFrame.get().setProgressLog("Prepare SmileyWarsModule (" + sw.getName() + ")");
            this.currentStep++;

            Logger.get().info("      - Add Method getField()");
            ClientFrame.get().setProgressLog("Add Method getField()");
            ...
            ClientFrame.get().setProgressLog("Prepare SmileyWarsMetaModule (" + swMeta.getName() + ")");
            this.currentStep++;

            Logger.get().info("      - Add Method getMetaField()");
            ClientFrame.get().setProgressLog("Add Method getMetaField()");
    ...
    private void prepareConnection() {
        try {
            ...
            ClientFrame.get().setProgressLog("Prepare Connection (" + connection.getName() + ")");
            this.currentStep++;
            ...
            ClientFrame.get().setProgressLog("Add Method getTunnel");
            this.currentStep++;
            connection.addMethod(CtMethod.make(
            ...
            ClientFrame.get().setProgressLog("Change Output Method (" + this.system.getManipulation().getConnectionOutput() + ")");
            this.currentStep++;
            ...
            ClientFrame.get().setProgressLog("Change Input Method (run)");
            this.currentStep++;
    ...
    private void prepareBingoFrame() {
        try {
            ...
            ClientFrame.get().setProgressLog("Prepare BingoFrame (" + bingoFrame.getName() + ")");
            this.currentStep++;
            //<editor-fold defaultstate="collapsed" desc="TUNNEL">
            ...
            ClientFrame.get().setProgressLog("Add Method check");
            this.currentStep++;
            ...
            ClientFrame.get().setProgressLog("Change Constructor");
            this.currentStep++;
    ...
    private void prepareGameFrame() {
        try {
            ...
            ClientFrame.get().setProgressLog("Prepare GameFrame (" + gameFrame.getName() + ")");
            this.currentStep++;
            //<editor-fold defaultstate="collapsed" desc="TUNNEL">
            ...
            ClientFrame.get().setProgressLog("Change Init Method (" + this.system.getManipulation().getGameFrameVoid() + ")");
            this.currentStep++;
